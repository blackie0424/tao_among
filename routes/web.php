...
Route::get('/fish/{id}/create', [FishNoteController::class,'create'])->name('fish.knowledge.create');
Route::post('/fish/{fish}/knowledge', [FishNoteController::class, 'storeKnowledge'])->name('fish.knowledge.store');
