    ...
    <div class="container mx-auto py-6">
        ...
        <button id="theme-toggle" class="fixed top-4 right-4 px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded">
            ...
            <div class="section-buttons flex space-x-4 my-4 p-4 rounded-lg">
                ...
                <a href="?locate=iayo" class="locate-filter px-6 py-2 bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-200 rounded-full hover:bg-blue-200 dark:hover:bg-blue-700 {{ request()->query('locate') === 'yayo' ? 'active' : '' }}">Yayo</a>
            </div>
