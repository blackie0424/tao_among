  ...
  <div class="container mx-auto p-4 max-w-lg">
    ...
    <div class="flex flex-col items-center mb-8">
      <div class="w-256 h-256 mb-2">
        <FishImage :image="fish.image" :name="fish.name" class="w-full h-full object-cover rounded-full" />
      </div>
    ...
    <form @submit.prevent="submitNote" class="space-y-6">
        ...
        <div class="flex flex-wrap gap-3">
          <button
            ...
            :class="[
              ...
              selectedLocate === loc.value ? 'bg-yellow-500 text-white border-yellow-500' : 'bg-gray-100 border-gray-300 hover:bg-yellow-100'
            ]"
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-3">
          <button
            ...
            :class="[
              'px-4 py-2 rounded-full border transition',
              selectedType === type ? 'bg-blue-500 text-white border-blue-500' : 'bg-gray-100 border-gray-300 hover:bg-blue-100'
            ]"
      ...
      <div v-if="showSuccess" class="text-green-600 mt-2">新增成功！你可以繼續新增或返回魚類頁。</div>
    </form>
  </div>
</template>
