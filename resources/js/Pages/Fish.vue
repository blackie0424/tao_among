          ...
          <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-4">
            ...
            >
              <div
                ...
                :class="
                  index % 2 === 0 ? 'bg-white border-teal-200' : 'bg-slate-50 border-slate-200'
                "
              >
                <!-- 卡片標題區：編號 -->
                <div
                ...
                <div class="p-4 flex flex-col gap-4">
                  ...
                  >
                    ...
                    捕獲地點：
                    <span class="bg-gray-200 text-sm px-2 py-0.5 rounded" v-if="record.tribe">{{
                      record.tribe
                    }}</span>
                  ...
                  >
                    <div class="flex items-start gap-2">
                      ...
                      <div>
                        <span class="text-base font-medium text-amber-800 block mb-1"
                          >捕獲說明</span
                        >
                        <p
                          class="text-base text-gray-800 leading-relaxed whitespace-pre-line break-words"
                        >
                          {{ record.notes }}
                        </p>
                      </div>
